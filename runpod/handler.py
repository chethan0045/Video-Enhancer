...
def handler(job):
    ...
    with tempfile.TemporaryDirectory() as work:
        ...
        # Rebuild video; carry original audio if present.
        _run([
            "ffmpeg", "-y", "-framerate", str(fps), "-i", os.path.join(out_frames, "%08d.png"),
            "-i", in_path, "-map", "0:v:0", "-map", "1:a:0?",
        ...
        if out_mode == "s3" and os.environ.get("S3_BUCKET"):
            ...
            return {"output_url": url, "width": w, "height": h}
        with open(out_path, "rb") as f:
            data = base64.b64encode(f.read()).decode("ascii")
        return {"output_base64": data, "width": w, "height": h}
